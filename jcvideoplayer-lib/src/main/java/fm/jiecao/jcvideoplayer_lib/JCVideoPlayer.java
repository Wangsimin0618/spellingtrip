...
//        surfaceView.setBackgroundColor(R.color.black_a10_color);
     ...
     */
    public void setUp(String url, String thumb, String title,Bitmap bitmap) {
        setUp(url, thumb, title, true,bitmap);
    }
     ...
     */
    public void setUp(String url, String thumb, String title, boolean ifShowTitle,Bitmap bitmap) {
        setSkin();
...
//        cancelDismissControlViewTimer();
    ...
    public void setYinCang(boolean b) {
        isYinCang=b;
    }
}
