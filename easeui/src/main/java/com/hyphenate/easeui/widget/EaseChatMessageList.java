...
public class EaseChatMessageList extends RelativeLayout{
    ...
    protected void parseStyle(Context context, AttributeSet attrs) {
        ...
        builder.showAvatar(ta.getBoolean(R.styleable.EaseChatMessageList_msgListShowUserAvatar, true))
                ...
                .otherBuddleBg(ta.getDrawable(R.styleable.EaseChatMessageList_msgListOtherBubbleBackground));
        itemStyle = builder.build();
      // itemStyle.setMyBubbleBg(context.getResources().getDrawable(R.drawable.ease_chatto_bg));
      // itemStyle.setOtherBubbleBg(context.getResources().getDrawable(R.drawable.otherbg));
        ta.recycle();
    }
