...
import com.spellingtrip.example.activity.GaoDeLoactionActivity;
import com.spellingtrip.example.utils.JsonUtil;

import java.util.ArrayList;
import java.util.List;

public class GaoDeAdapter extends BaseAdapter {
    ...
    public GaoDeAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.view_holder_homeamapresult, parent, false);
    ...
    class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            image_checknor = (ImageView) view.findViewById(R.id.image_checknor);
        }
        ...
        public void bindView(int position) {
            ...
            //  imageCheck.setVisibility(position == selectedPosition ? View.VISIBLE : View.GONE);
