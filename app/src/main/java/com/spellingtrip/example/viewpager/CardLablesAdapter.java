...
public class CardLablesAdapter extends RecyclerView.Adapter<CardLablesAdapter.MyViewHolder> {

    private Context context;
    private List<UserShowBean.DataBean.LabelsBean> list;

    private int defItem = -1;


    public CardLablesAdapter(Context context, List<UserShowBean.DataBean.LabelsBean> list) {
