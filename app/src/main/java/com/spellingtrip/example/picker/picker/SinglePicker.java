package com.spellingtrip.example.picker.picker;
...
import com.spellingtrip.example.picker.widget.ConvertUtils;
...
public class SinglePicker<T> extends WheelPicker {
    ...
    protected View makeCenterView() {
        ...
        if (TextUtils.isEmpty(label)) {
            wheelView.setLayoutParams(new LinearLayout.LayoutParams(screenWidthPixels, ViewGroup.LayoutParams.WRAP_CONTENT));
        } else {
            wheelView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
