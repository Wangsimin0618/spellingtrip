...
public class SeachLabelresultActivity extends BaseActivity implements OnRefreshLoadMoreListener {
    public static final String TAG = "SeachLabelresult";
...
//        setContentView();
    ...
    protected void getData() {
        ...
        if (logineDialog == null) {
            logineDialog = new LogineDialog(SeachLabelresultActivity.this, "正在加载");
        }
        logineDialog.show();
    ...
    private void setSeachResult(List<ActivityAABean.DataBean> citys) {
        if (aaCityAdapter == null) {
            aaCityAdapter = new HomeitemAdapter(SeachLabelresultActivity.this, citys, "home");
