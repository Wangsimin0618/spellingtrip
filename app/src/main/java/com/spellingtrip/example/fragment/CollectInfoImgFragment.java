...
public class CollectInfoImgFragment extends DialogFragment {
    ...
    private List<MyCollectBean.DataBean.RowsBean.ImagesBean> list;
    private int mPosition;



    public void setData(List<MyCollectBean.DataBean.RowsBean.ImagesBean> imgpaths, int pos) {
        this.list = imgpaths;
        this.mPosition = pos;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        CollectImgViewPagerAdapter adapter= new CollectImgViewPagerAdapter( list);
    ...
    public  class CollectImgViewPagerAdapter extends PagerAdapter {
        private List<MyCollectBean.DataBean.RowsBean.ImagesBean> imageurl;


        public CollectImgViewPagerAdapter(List<MyCollectBean.DataBean.RowsBean.ImagesBean> imageurl) {
