...
public class PublishInfoImgFragment extends DialogFragment {
    ...
    private List<MyPublishBean.DataBean.ImagesBean> list;
    private int mPosition;



    public void setData(List<MyPublishBean.DataBean.ImagesBean> imgpaths, int pos) {
        this.list = imgpaths;
        this.mPosition = pos;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        PublishImgViewPagerAdapter adapter= new PublishImgViewPagerAdapter( list);
    ...
    public  class PublishImgViewPagerAdapter extends PagerAdapter {
        private List<MyPublishBean.DataBean.ImagesBean> imageurl;


        public PublishImgViewPagerAdapter(List<MyPublishBean.DataBean.ImagesBean> imageurl) {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            Glide.with(container.getContext()).load(list.get(position).getThumbnailPath()).asBitmap().
