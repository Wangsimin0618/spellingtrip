package com.spellingtrip.example.phoenix;
...
public class MediaAdapter extends RecyclerView.Adapter<MediaAdapter.ViewHolder> {
    ...
    public MediaAdapter(OnAddMediaListener mOnAddMediaListener,Activity activity) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            rlItemImage=view.findViewById(R.id.rlItemImage);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
       ...
       int spex= CommonUtil.dipToPx(activity,3)*3;
       int width=CommonUtil.getScreenWidth(activity)/4;
        layoutParams.width=width-spex;
        layoutParams.height=width-spex;
        ...
        if (getItemViewType(position) == TYPE_ADD) {
            if (mMediaList.size()==9){
                ...
                viewHolder.ivPicture.setImageResource(R.drawable.add);
            }
