...
public class ChatRoomDetailsActivity extends BaseChatActivity implements OnClickListener {
	...
	private class MemberAdapter extends ArrayAdapter<String> {
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			if (isInMuteList(username)) {
				...
				id_background.setBackgroundColor(convertView.getResources().getColor(R.color.articleTitle));
			} else {
