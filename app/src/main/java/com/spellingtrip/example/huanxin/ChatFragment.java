...
import com.spellingtrip.example.huanxin.EaseChatFragment.EaseChatFragmentHelper;
...
import com.spellingtrip.example.huanxin.weigt.EaseChatRecallPresenter;
import com.spellingtrip.example.huanxin.weigt.EaseChatVoiceCallPresenter;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    protected void setUpView() {
        ...
        if (chatType == Constanthuan.CHATTYPE_SINGLE) {
    ...
    protected void registerExtendMenuItem() {
       ...
       // inputMenu.registerExtendMenuItem(R.string.attach_file, R.drawable.em_chat_file_selector, ITEM_FILE, extendMenuItemClickListener);
        ...
        } else if (chatType == Constanthuan.CHATTYPE_GROUP) { // 音视频会议  18061977079
    ...
    public void onSetMessageAttributes(EMMessage message) {
      ...
      /*  String userPic = PreferenceUtil.getString(ConstantsBean.FROM_AVATER, "");
        if (!TextUtils.isEmpty(userPic)) {
            message.setAttribute(ConstantsBean.FROM_AVATER, userPic);
        }
        String userName = PreferenceUtil.getString(ConstantsBean.FROM_NICHENG, "");
        if (!TextUtils.isEmpty(userName)) {
            message.setAttribute(ConstantsBean.FROM_NICHENG, userName);
        }*/
    }
    ...
    private final class CustomChatRowProvider implements EaseCustomChatRowProvider {
        ...
        public int getCustomChatRowType(EMMessage message) {
            if(message.getType() == EMMessage.Type.TXT){
                //voice call
                if (message.getBooleanAttribute(Constanthuan.MESSAGE_ATTR_IS_VOICE_CALL, false)){
                    return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_VOICE_CALL : MESSAGE_TYPE_SENT_VOICE_CALL;
                }else if (message.getBooleanAttribute(Constanthuan.MESSAGE_ATTR_IS_VIDEO_CALL, false)){
                    //video call
                    return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_VIDEO_CALL : MESSAGE_TYPE_SENT_VIDEO_CALL;
                }
                 //messagee recall
                else if(message.getBooleanAttribute(Constanthuan.MESSAGE_TYPE_RECALL, false)){
                    return MESSAGE_TYPE_RECALL;
                } else if (!"".equals(message.getStringAttribute(Constanthuan.MSG_ATTR_CONF_ID,""))) {
                    return MESSAGE_TYPE_CONFERENCE_INVITE;
                } else if (Constanthuan.OP_INVITE.equals(message.getStringAttribute(Constanthuan.EM_CONFERENCE_OP, ""))) {
        ...
        public EaseChatRowPresenter getCustomChatRow(EMMessage message, int position, BaseAdapter adapter) {
            if(message.getType() == EMMessage.Type.TXT){
                ...
                if (message.getBooleanAttribute(Constanthuan.MESSAGE_ATTR_IS_VOICE_CALL, false) ||
                    message.getBooleanAttribute(Constanthuan.MESSAGE_ATTR_IS_VIDEO_CALL, false)){
