...
public class ContextMenuActivity extends BaseChatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (type == EMMessage.Type.TXT.ordinal()) {
		    if(message.getBooleanAttribute(Constanthuan.MESSAGE_ATTR_IS_VIDEO_CALL, false)
					|| message.getBooleanAttribute(Constanthuan.MESSAGE_ATTR_IS_VOICE_CALL, false)){
				setContentView(R.layout.em_context_menu_for_location);
		    }else if(message.getBooleanAttribute(Constanthuan.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
