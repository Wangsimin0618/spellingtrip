package com.spellingtrip.example.huanxin.db;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(CustomApplication.getInstance().getApplicationContext());
    }
    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(Constanthuan.NEW_FRIENDS_USERNAME) || username.equals(Constanthuan.GROUP_USERNAME)
                        || username.equals(Constanthuan.CHAT_ROOM)|| username.equals(Constanthuan.CHAT_ROBOT)) {
