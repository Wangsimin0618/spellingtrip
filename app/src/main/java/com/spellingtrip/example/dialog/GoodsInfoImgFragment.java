...
/**
 * Created by Administrator on 2019/3/7 0002.
 */

public class GoodsInfoImgFragment extends DialogFragment {
    ...
    private List<TourisnBean.DataBean.ImagesBean> list;
    private int mPosition;

    public void setData(List<TourisnBean.DataBean.ImagesBean> imgpaths, int pos) {
        this.list = imgpaths;
        this.mPosition = pos;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        GoodsInfoImgViewPagerAdapter adapter= new GoodsInfoImgViewPagerAdapter( list);
    ...
    public  class GoodsInfoImgViewPagerAdapter extends PagerAdapter {
        private List<TourisnBean.DataBean.ImagesBean> imageurl;


        public GoodsInfoImgViewPagerAdapter(List<TourisnBean.DataBean.ImagesBean> imageurl) {
