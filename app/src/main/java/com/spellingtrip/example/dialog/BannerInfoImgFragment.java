...
public class BannerInfoImgFragment extends DialogFragment {
    private static final String TAG = "BottomFragment";
    private RelativeLayout rlgoodsinfopager;
    private ViewPager vp_goodspager;
    private GoodsInfoImgFragment.OnDismissListener mOnDismissListener;
    private TextView mTitleTv;
    private List<BannerBean> list;
    private int mPosition;

    public void setData(List<BannerBean> imgpaths, int pos) {
        this.list = imgpaths;
        this.mPosition = pos;
    }
    ...
    public void setOnDismissListener(GoodsInfoImgFragment.OnDismissListener onDismissListener) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        BannerInfoImgViewPagerAdapter adapter= new BannerInfoImgViewPagerAdapter( list);
      /*  vp_goodspager.setPageMargin((int) (getResources().getDisplayMetrics().density * 15));
        vp_goodspager.setAdapter(new PagerAdapter() {
            @Override
            public int getCount() {
                return list.size();
            }
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                Glide.with(container.getContext()).load(list.get(position).getOriginPath()).asBitmap().
    ...
    public  class BannerInfoImgViewPagerAdapter extends PagerAdapter {
        private List<BannerBean> imageurl;


        public BannerInfoImgViewPagerAdapter(List<BannerBean> imageurl) {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            view.enable();
            view.setScaleType(ImageView.ScaleType.FIT_CENTER);
            Glide.with(container.getContext()).load(list.get(position).getFilepath()).asBitmap().
                    diskCacheStrategy(DiskCacheStrategy.RESULT).into(view);
