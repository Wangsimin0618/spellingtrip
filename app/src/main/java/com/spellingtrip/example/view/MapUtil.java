...
public class MapUtil {
     ...
     * @param dname 终点名称 必填
     */
    public static void openGaoDeNavi(Context context, double slat, double slon, String sname, String dlat, String dlon, String dname){
     ...
     */
    public static void openTencentMap(Context context, double slat, double slon, String sname, String dlat, String dlon, String dname) {
        String uriString = null;
     ...
     * @param dname 终点名称 必填
     */
    public static void openBaiDuNavi(Context context,double slat, double slon, String sname, String dlat, String dlon, String dname){
        String uriString = null;
        //终点坐标转换
