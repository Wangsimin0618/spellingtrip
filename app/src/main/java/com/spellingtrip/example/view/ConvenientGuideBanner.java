...
public class ConvenientGuideBanner<T> extends LinearLayout {
    ...
    public ConvenientGuideBanner(Context context) {
        super(context);
        init(context);
    }

    public ConvenientGuideBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ConvenientGuideBanner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public ConvenientGuideBanner(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    static class AdSwitchTask implements Runnable {
        ...
        private final WeakReference<ConvenientGuideBanner> reference;

        AdSwitchTask(ConvenientGuideBanner convenientBanner) {
            this.reference = new WeakReference<ConvenientGuideBanner>(convenientBanner);
        }

        @Override
        public void run() {
            ConvenientGuideBanner convenientBanner = reference.get();
    ...
    public ConvenientGuideBanner setPages(CBViewHolderCreator holderCreator, List<T> datas) {
        this.mDatas = datas;
     ...
     * @param visible
     */
    public ConvenientGuideBanner setPointViewVisible(boolean visible) {
     ...
     */
    public ConvenientGuideBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(10, 0, 10, 20);
     ...
     * @return
     */
    public ConvenientGuideBanner setPageIndicatorAlign(PageIndicatorAlign align) {
     ...
     * @return
     */
    public ConvenientGuideBanner startTurning(long autoTurningTime) {
        //如果是正在翻页的话先停掉
        if (turning) {
            stopTurning();
        }
     ...
     * @return
     */
    public ConvenientGuideBanner setPageTransformer(ViewPager.PageTransformer transformer) {
     ...
     * @return
     */
    public ConvenientGuideBanner setOnPageChangeListener(ViewPager.OnPageChangeListener onPageChangeListener) {
     ...
     */
    public ConvenientGuideBanner setOnItemClickListener(OnItemClickListener onItemClickListener) {
