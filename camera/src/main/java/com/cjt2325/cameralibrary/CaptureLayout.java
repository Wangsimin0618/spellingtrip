...
public class CaptureLayout extends FrameLayout {
    ...
    private void initView() {
       ...
       // btn_cancel = new TypeButton(getContext(), TypeButton.TYPE_CANCEL, button_size);
        btn_cancel=new TextView(getContext());
        final LayoutParams btn_cancel_param = new LayoutParams(dipToPx(getContext(),80), dipToPx(getContext(),80));
        ...
        btn_cancel.setBackgroundDrawable(getResources().getDrawable(R.drawable.chongpai_shape));
        btn_cancel.setText("重拍");
...
//                resetCaptureLayout();
      ...
      //  btn_confirm = new TypeButton(getContext(), TypeButton.TYPE_CONFIRM, button_size);
        ...
        btn_confirm=new TextView(getContext());
        final LayoutParams btn_confirm_param = new LayoutParams(dipToPx(getContext(),80), dipToPx(getContext(),80));
        ...
        btn_confirm.setBackgroundDrawable(getResources().getDrawable(R.drawable.fabu_shape));
