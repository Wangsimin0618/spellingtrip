...
//    private static final String TAG = "JCameraView";
    ...
    private void initView() {
        ...
        llTopRight= (LinearLayout) view.findViewById(R.id.llTopRight);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setIsPaiZhao(boolean b) {
        if (b){
            mCaptureLayout.setButtonFeatures(BUTTON_STATE_ONLY_CAPTURE);
            mCaptureLayout.setCaptureLisenter(new CaptureListener() {
                @Override
                public void takePictures() {
                    mSwitchCamera.setVisibility(INVISIBLE);
            ...
            mCaptureLayout.setButtonFeatures(BUTTON_STATE_BOTH);
            mCaptureLayout.setCaptureLisenter(new CaptureListener() {
                @Override
                public void takePictures() {
                    mSwitchCamera.setVisibility(INVISIBLE);
